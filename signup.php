...
echo '</button>';
echo '<a class="navbar-brand" href="index.php" style="color: rgb(173, 222, 255);">soundspace.com</a>';
echo '';
...
echo '<br>';
echo '<input id="inputLName" name="inputLName" class="form-control" style="background-color: aliceblue; color: black;" placeholder="Last Name" required>';
echo '<br>';
echo '<input type="email" id="inputEmail" name="inputEmail" class="form-control" style="background-color: aliceblue; color: black;" placeholder="Email address"  required>';
echo '<br>';
echo '<input id="phone" onblur="color: black" class="form-control" name="phone" style="background-color: aliceblue; color: black;" placeholder="Phone Numer"  required>';
echo '<br>';
echo '<input type="password" id="inputPassword" name="inputPassword" class="form-control" style="background-color: aliceblue; color: black;" placeholder="Password"  required>';
